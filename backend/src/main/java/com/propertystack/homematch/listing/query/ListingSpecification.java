...
public class ListingSpecification {
    ...
    private static Specification<Listing> location(String location) {
        return (root, query, cb) -> {
            ...
            if (looksLikeZipCode(trimmed)) {
                return cb.equal(root.get("zipCode"), trimmed);
            }
    ...
    private static boolean looksLikeZipCode(String value) {
