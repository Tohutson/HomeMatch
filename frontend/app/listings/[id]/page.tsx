...
export default function ListingDetailPage({
  ...
  useEffect(() => {
    fetch(`${API_BASE}/api/listings/${params.id}`)
      .then((res) => {
  ...
  const handleUndo = async () => {
    ...
    setUndoTimeLeft(0);
    setToast(
      `Removed ${undoListing.address ?? "property"} from favorites`
    );
  };
    ...
    <main className="min-h-screen bg-zinc-50 p-8 text-black">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        {listing.photoUrls && listing.photoUrls.length > 0 ? (
          ...
          <div className="mb-6 flex h-72 w-full items-center justify-center
                          rounded-xl bg-zinc-200 text-zinc-500">
            No Images Available
          </div>
        )}
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-6">
          ...
          {listing.listingUrl && (
              ...
              className="inline-block rounded-lg bg-zinc-800 px-4 py-2
